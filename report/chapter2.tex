...
Le bug se situe dans l'exécution de la commande \lstinline{dbw} dans l'interpréteur Radare2. Voici un extrait du log de ASAN lorsque l'on exécute cette commande dans Radare2 :
